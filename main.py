...
################################## Tool Bar ####################################
        ...
        self.btngive = Button(topFrame, text='Borrow Book', image=self.icongive, compound=LEFT, font='arial 12 bold', padx=10, command=self.giveBook)
