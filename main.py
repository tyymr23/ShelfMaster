    ...
    def __init__(self, master):
        ...
        def displayBooks(self):
            ...
            def bookInfo(event):
                ...
                self.listDetails.insert(1, 'Book Author : ' + bookInfo[0][2])
                self.listDetails.insert(2, 'Book Page : ' + bookInfo[0][3])
                self.listDetails.insert(3, 'Book Language : ' + bookInfo[0][4])
                if bookInfo[0][5] == 0:
